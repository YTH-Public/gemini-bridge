...
```bash
python3 ~/.claude/skills/gemini-bridge/bridge.py --dir "<프로젝트절대경로>" send "<메시지>" --topic "<토픽>"
```
...
```bash
python3 ~/.claude/skills/gemini-bridge/bridge.py --dir "<프로젝트절대경로>" ask "<메시지>" --topic "<토픽>" --timeout 600 --retries 3
```
...
```bash
python3 ~/.claude/skills/gemini-bridge/bridge.py --dir "<프로젝트절대경로>" --source gemini latest
```

### 목록 (list)

```bash
python3 ~/.claude/skills/gemini-bridge/bridge.py --dir "<프로젝트절대경로>" --source gemini list
```

### 검색 (search)

```bash
python3 ~/.claude/skills/gemini-bridge/bridge.py --dir "<프로젝트절대경로>" --source gemini search "<키워드>"
```
